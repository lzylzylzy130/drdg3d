...
Point(1) = {0, -2,   0, lc_fault};
Point(2) = {0,  2,   0, lc_fault};
Point(3) = {0,  2, -2, lc_fault};
Point(4) = {0, -2, -2, lc_fault};
Line(1) = {1, 2};
Line(2) = {2, 3};
Line(3) = {3, 4};
Line(4) = {4, 1};
...
Plane Surface(1) = {1};
Point(5) = {0, -0.25, -0.75, lc_fault};
Point(6) = {0,  0.25, -0.75, lc_fault};
Point(7) = {0,  0.25, -1.25, lc_fault};
Point(8) = {0, -0.25, -1.25, lc_fault};
Line(5) = {5, 6};
Line(6) = {6, 7};
Line(7) = {7, 8};
Line(8) = {8, 5};
